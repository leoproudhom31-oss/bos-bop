...
function facebookButtonHtml(url: string): string {
  ...
  return (
    ...
    `style="display:inline-flex;align-items:center;gap:8px;color:#ddc076;text-decoration:none;` +
    `font-weight:600;border:1px solid #ddc076;border-radius:6px;padding:10px 16px;">` +
